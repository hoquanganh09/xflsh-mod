...
class UserRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->get('/getSubscribe', 'User\\UserController@subscribe');
            ...
            $router->get('/trafficLogs', 'User\\UserController@trafficLogs');
            $router->get('/trafficHeatMap', 'User\\UserController@trafficHeatMap');
            ...
            $router->get('/server/overview', 'User\\ServerController@overview');
